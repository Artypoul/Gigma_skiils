...
description: "Route a website task to the right site-sense skill and act as the common entrypoint across projects for website strategy, meanings, offer, hero, structure, SEO, page copy, and copy review. Use whenever the user asks in broad or fuzzy language such as сайт, лендинг, смыслы сайта, оффер, позиционирование, hero, структура сайта, тексты сайта, sitemap, IA, CTA, FAQ, copy, or when the agent is unsure which site-sense skill should run first."
---
...
Do not guess between strategy, IA, SEO, copy, and review. Route deliberately.
...
| Need product context, audience, jobs, proof, or business framing before meanings or copy | `product-marketing-context` |
| Need meanings, positioning, offer, hero direction, message hierarchy, objections, or differentiation | `meaning-positioning` |
...
2. If the user asks only for words like `смыслы`, `оффер`, `позиционирование`, or `hero`, route to `meaning-positioning`.
...
6. If the project has real product or legal constraints, read project instructions first and keep them above generic website heuristics.
...
5. If the task is blocked because the project lacks context, ask only the minimum questions or continue with explicit assumptions if the user prefers speed.
