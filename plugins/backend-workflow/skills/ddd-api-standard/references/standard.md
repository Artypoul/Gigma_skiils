...
**Версия 3.6 · Проверено 16.08.2026 · Профиль: FastAPI, SQLAlchemy 2.x, PostgreSQL, Alembic — конкретные версии берутся из lockfile и runtime проекта, а не из этого документа**
